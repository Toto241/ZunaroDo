...
class AlltagshelferGUI(ctk.CTk):
    ...
    SETTING_FIELDS: list[tuple[str, str, str]] = [
        ...
        ("gemini.max_tokens", "Max. Antwort-Tokens",
         "Max. Tokens je Antwort (Default 2048)"),
        ("imap.host", "IMAP-Host",
         "Leer = aus. Login ueber Env (ALLTAGSHELFER_IMAP_PASS)."),
        ("imap.user", "IMAP-Benutzer", "Anmeldename, oft die E-Mail-Adresse"),
        ("imap.folder", "IMAP-Ordner", "Standard: INBOX"),
        ("smtp.host", "SMTP-Host",
         "Leer = aus. Passwort ueber Env (ALLTAGSHELFER_SMTP_PASS)."),
        ("smtp.port", "SMTP-Port", "Default 587 (STARTTLS) oder 465 (SSL)"),
        ("smtp.user", "SMTP-Benutzer", "Anmeldename, oft die E-Mail-Adresse"),
        ("smtp.sender", "SMTP-Absender", "Absender-Adresse, z.B. name@example.com"),
        ...
        ("sync.interval_seconds", "Sync-Intervall (s)",
         "Sekunden zwischen Sync-Laeufen (Default 300)"),
        ("notify.warn_within_days", "Notifikationen ab Tagen",
         "Vorwarnzeit vor Fristen in Tagen (Default 14)"),
        ("i18n.language", "Sprache",
         "auto | de | en | fr | it | nl | pt (greift erst beim Neustart)"),
        ("backup.auto_enabled", "Auto-Backup", "true / false"),
        ("backup.directory", "Backup-Ordner",
         "Zielordner fuer Backups (Default: backups)"),
        ("backup.retention_count", "Backups behalten",
         "Anzahl aufbewahrter Backups (Default 10)"),
        ("backup.interval_hours", "Backup-Intervall (h)",
         "Stunden zwischen Auto-Backups (Default 24)"),
    ]
