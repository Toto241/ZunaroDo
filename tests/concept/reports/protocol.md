...
- Datum: 2026-05-20 16:37:16 UTC
- Host: Toto241 (Windows-10-10.0.26200-SP0)
- Python: 3.11.9
- Target: `tests`
- Laufzeit pytest: 157.80 s
...
| skipped | 3 |
| **gesamt** | **984** |
| Dauer (Summe) | 155.51 s |

## Abdeckung nach Konzept-Bereich (Anhang)

| Bereich (Anhang) | Tests | passed | failed | error | skipped | Dauer (s) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Kapitel 2 / Anhang D - Mitglieder-Szenarien | 18 | 18 | 0 | 0 | 0 | 71.06 |
| Anhang D - Rollen- und Berechtigungsmatrix | 69 | 69 | 0 | 0 | 0 | 0.99 |
| Kapitel 3 / Anhang C - Pairwise-Matrix | 13 | 13 | 0 | 0 | 0 | 4.08 |
| Kapitel 8 - Property-/Fuzz-Tests | 29 | 29 | 0 | 0 | 0 | 10.26 |
| Teil II Abschnitt 11 - Negativtests | 48 | 48 | 0 | 0 | 0 | 10.37 |
| Teil II Abschnitt 12 - Datenschutztests | 250 | 250 | 0 | 0 | 0 | 2.63 |
| Teil II Abschnitt 11.3 D - Security-Negativtests | 22 | 22 | 0 | 0 | 0 | 0.03 |
| Anhang J + J2 - Release-Gate | 197 | 197 | 0 | 0 | 0 | 2.16 |

## Ergebnisse pro Testdatei

| Datei | Tests | passed | failed | error | skipped | Dauer (s) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| TestAssistantLogRotation | 1 | 1 | 0 | 0 | 0 | 0.35 |
| TestAutoBackup | 2 | 2 | 0 | 0 | 0 | 0.50 |
| TestBackupAndRestore | 3 | 3 | 0 | 0 | 0 | 0.67 |
| TestBackupSqlCipherPath | 2 | 2 | 0 | 0 | 0 | 0.00 |
| TestBulkInsertPerformance | 3 | 3 | 0 | 0 | 0 | 6.92 |
| TestBulkOperations | 3 | 3 | 0 | 0 | 0 | 0.72 |
| TestCalendarNoMutation | 1 | 1 | 0 | 0 | 0 | 0.21 |
...
| TestDeleteCapabilities | 4 | 4 | 0 | 0 | 0 | 0.87 |
...
| TestHasCapabilityHonorsDisabled | 2 | 2 | 0 | 0 | 0 | 0.38 |
...
| TestRecurrenceValidation | 5 | 5 | 0 | 0 | 0 | 0.93 |
...
| TestReviewFixes | 18 | 18 | 0 | 0 | 0 | 11.01 |
...
| test_dashboard_generator | 20 | 20 | 0 | 0 | 0 | 0.91 |
| test_md_to_html | 15 | 15 | 0 | 0 | 0 | 0.01 |
| test_members_scenarios | 18 | 18 | 0 | 0 | 0 | 71.06 |
| test_negative_inputs | 40 | 40 | 0 | 0 | 0 | 7.75 |
| test_negative_network | 8 | 8 | 0 | 0 | 0 | 2.62 |
| test_negative_security | 22 | 22 | 0 | 0 | 0 | 0.03 |
| test_pairwise_matrix | 13 | 13 | 0 | 0 | 0 | 4.08 |
| test_privacy_data_rights | 10 | 10 | 0 | 0 | 0 | 2.21 |
| test_privacy_scan | 240 | 240 | 0 | 0 | 0 | 0.42 |
...
| test_roles_permissions | 69 | 69 | 0 | 0 | 0 | 0.99 |
...
| [pass] | `tests.concept.test_dashboard_generator::test_failure_section_shows_when_records_failed` | 0.048 |
...
| [pass] | `tests.concept.test_dashboard_generator::test_html_escapes_html_in_test_id` | 0.047 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_has_kpi_for_each_marker` | 0.077 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_has_navigation` | 0.076 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_is_self_contained` | 0.077 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_links_to_companion_artifacts` | 0.075 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_renders_decision_pill` | 0.079 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_renders_skipped_as_hold` | 0.074 |
| [pass] | `tests.concept.test_dashboard_generator::test_main_handles_missing_input` | 0.003 |
| [pass] | `tests.concept.test_dashboard_generator::test_main_runs_against_real_protocol` | 0.105 |
| [pass] | `tests.concept.test_dashboard_generator::test_render_dashboard_is_deterministic` | 0.093 |
...
| [pass] | `tests.concept.test_members_scenarios::test_M01_single_owner_no_rotation` | 0.380 |
| [pass] | `tests.concept.test_members_scenarios::test_M02_minimal_team_two_members` | 0.828 |
| [pass] | `tests.concept.test_members_scenarios::test_M05_meets_play_minimum_12` | 4.689 |
| [pass] | `tests.concept.test_members_scenarios::test_M06_scales_to_twenty_plus` | 6.792 |
| [pass] | `tests.concept.test_members_scenarios::test_M07_mixed_status_distribution` | 4.858 |
| [pass] | `tests.concept.test_members_scenarios::test_M08_invited_only_owner_active` | 0.634 |
| [pass] | `tests.concept.test_members_scenarios::test_M09_reactivation_restores_member` | 1.331 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-01]` | 0.411 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-02]` | 0.745 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-03]` | 1.920 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-04]` | 3.276 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-05]` | 4.823 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-06]` | 6.837 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-07]` | 4.765 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-08]` | 0.574 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-09]` | 1.304 |
| [pass] | `tests.concept.test_members_scenarios::test_get_events_handles_all_sizes` | 24.984 |
| [pass] | `tests.concept.test_members_scenarios::test_remove_and_readd_preserves_distinct_id` | 1.908 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_contract_name_does_not_break_listing` | 0.181 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[10000]` | 0.182 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[1024]` | 0.207 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[65536]` | 0.181 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description["Anna' DROP"]` | 0.224 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['  trailing space   ']` | 0.199 |
...
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna\\x00Nachher']` | 0.177 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\\u202earabicRTL']` | 0.191 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\u0410\u043d\u043d\u0430 \u0418\u0432\u0430\u043d\u043e\u0432\u0430']` | 0.190 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\u5c71\u7530\u592a\u90ce']` | 0.187 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name["Anna' DROP"]` | 0.218 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['  trailing space   ']` | 0.185 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name[' ']` | 0.166 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['<script>alert(1)</scrip]` | 0.206 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['Anna \U0001f600']` | 0.183 |
...
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields['); DELETE FROM cont]` | 0.181 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[1' OR '1'='1]` | 0.156 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna"; UPDATE family]` | 0.188 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna'; DROP TABLE fa]` | 0.198 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna\\'; SELECT * FRO]` | 0.192 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[%27%20OR%201=1%20--%]` | 0.198 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal['); DELETE FROM cont]` | 0.202 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[1' OR '1'='1]` | 0.204 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna"; UPDATE family]` | 0.194 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna'; DROP TABLE fa]` | 0.193 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna\\'; SELECT * FRO]` | 0.206 |
| [pass] | `tests.concept.test_negative_inputs::test_NA05_double_member_is_idempotent_or_distinct_ids` | 0.216 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_invalid_param_type_does_not_crash` | 0.215 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_missing_required_param_returns_friendly_error` | 0.188 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_unknown_capability_returns_friendly_error` | 0.212 |
| [pass] | `tests.concept.test_negative_network::test_NB01_unreachable_server_does_not_corrupt_state` | 2.049 |
| [pass] | `tests.concept.test_negative_network::test_NB04_garbage_response_is_handled` | 0.516 |
| [pass] | `tests.concept.test_negative_network::test_NB04_server_500_does_not_silently_succeed` | 0.013 |
| [pass] | `tests.concept.test_negative_network::test_NB06_corrupt_log_lines_are_skipped` | 0.009 |
| [pass] | `tests.concept.test_negative_network::test_NB06_offline_then_sync_round_trips_events` | 0.017 |
...
| [pass] | `tests.concept.test_pairwise_matrix::test_matrix_respects_constraints` | 0.828 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[0]` | 0.170 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[100]` | 0.169 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[125]` | 0.171 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[150]` | 0.295 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[175]` | 0.297 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[25]` | 0.158 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[50]` | 0.203 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[75]` | 0.205 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB02_purging_member_decouples_references` | 0.191 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_calendar-termine.csv-calendar]` | 0.214 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_contracts-vertraege.csv-contracts]` | 0.182 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_expenses-ausgaben.csv-expenses]` | 0.191 |
...
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_export_all_produces_parseable_artifacts` | 0.178 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB04_soft_delete_hides_then_restore_brings_back` | 0.261 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB06_dropping_db_file_removes_all_data` | 0.354 |
| [pass] | `tests.concept.test_privacy_data_rights::test_audit_log_format_does_not_leak_pii` | 0.190 |
...
| [pass] | `tests.concept.test_privacy_scan::test_PB01_account_deletion_capability_exists` | 0.174 |
...
| [pass] | `tests.concept.test_privacy_scan::test_PD01_no_cleartext_http_urls[mobile/screens/contracts.py]` | 0.002 |
...
| [pass] | `tests.concept.test_properties_concept::test_P1_rotation_advances_one_step` | 4.176 |
| [pass] | `tests.concept.test_properties_concept::test_P2_overdue_task_rolls_forward_to_future` | 4.480 |
...
| [pass] | `tests.concept.test_properties_concept::test_P6_pairwise_deterministic` | 1.578 |
...
| [pass] | `tests.concept.test_release_gate::test_J10_full_module_registry_assembles` | 0.206 |
...
| [pass] | `tests.concept.test_release_gate::test_J7_pairwise_matrix_has_full_coverage` | 0.804 |
...
| [pass] | `tests.concept.test_roles_permissions::test_destructive_capabilities_have_marker` | 0.175 |
| [pass] | `tests.concept.test_roles_permissions::test_guest_cannot_modify_data` | 0.001 |
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_blocks_ai_in_free` | 0.184 |
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_blocks_finance_writes_in_free` | 0.197 |
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_passes_family_in_free` | 0.183 |
...
| [pass] | `tests.concept.test_roles_permissions::test_owner_concept_role_maps_to_pro_license` | 0.193 |
| [pass] | `tests.test_gui_smoke.TestGuiImports::test_geometry_helpers` | 0.076 |
...
| [pass] | `tests.test_integration.TestPrinten::test_print_file_calls_lpr_on_macos` | 0.003 |
...
| [pass] | `tests.test_mobile_helpers.TestDaysUntil::test_past` | 0.002 |
| [pass] | `tests.test_mobile_helpers.TestDaysUntil::test_today` | 0.002 |
...
| [pass] | `tests.test_mobile_helpers.TestRelativeWhen::test_future` | 0.002 |
| [pass] | `tests.test_mobile_helpers.TestRelativeWhen::test_invalid_returns_empty` | 0.001 |
| [pass] | `tests.test_mobile_helpers.TestRelativeWhen::test_past` | 0.002 |
...
| [pass] | `tests.test_pairing.TestKeyringSecureStore::test_delete_removes_from_list` | 0.059 |
...
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_insert_500_contracts_under_15s` | 3.082 |
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_insert_500_expenses_under_15s` | 2.726 |
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_list_200_contracts_under_2s` | 1.113 |
| [pass] | `tests.test_performance.TestDeadlineCalculationPerformance::test_deadline_calculation_scales` | 0.123 |
| [pass] | `tests.test_performance.TestNotesListingPerformance::test_list_attached_in_large_dataset` | 6.231 |
...
| [pass] | `tests.test_playstore_check.TestRunChecksIntegration::test_runs_without_exception` | 0.117 |
| [pass] | `tests.test_playstore_check.TestRunChecksIntegration::test_subset_only` | 0.004 |
| [pass] | `tests.test_smoke.TestAssistantLogRotation::test_log_does_not_grow_unbounded` | 0.347 |
...
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_list_backups_sorted_newest_first` | 0.234 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_online_backup_creates_readable_copy` | 0.218 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_restore_overwrites_live_db` | 0.221 |
...
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_complete_overdue_tasks` | 0.249 |
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_delete_archived` | 0.257 |
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_reject_open_proposals` | 0.215 |
| [pass] | `tests.test_smoke.TestCalendarNoMutation::test_recurring_event_not_mutated_in_db` | 0.210 |
| [pass] | `tests.test_smoke.TestCompleteTaskCatchUp::test_overdue_task_advances_rotation_multiple_times` | 0.221 |
| [pass] | `tests.test_smoke.TestConversationHistory::test_history_grows_across_calls` | 0.252 |
| [pass] | `tests.test_smoke.TestCsvExport::test_export_all_writes_five_files` | 0.294 |
| [pass] | `tests.test_smoke.TestCsvExport::test_export_contracts_writes_csv` | 0.207 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_export_then_import_reproduces_data` | 0.468 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_invalid_dates_dont_crash` | 0.254 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_missing_csv_files_are_skipped` | 0.220 |
| [pass] | `tests.test_smoke.TestDayStructurePersistence::test_entry_persists` | 0.196 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_caps_are_destructive` | 0.220 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_contract_round_trip` | 0.246 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_member_keeps_orphan_contracts` | 0.237 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_unknown_returns_error` | 0.163 |
| [pass] | `tests.test_smoke.TestDestructiveFlags::test_critical_capabilities_are_marked` | 0.206 |
| [pass] | `tests.test_smoke.TestDiagnose::test_collect_returns_expected_shape` | 1.049 |
| [pass] | `tests.test_smoke.TestDisabledModuleSurfaced::test_disabled_contracts_yields_warning_in_finance_events` | 0.182 |
| [pass] | `tests.test_smoke.TestEncryption::test_encryption_requires_sqlcipher3` | 0.003 |
| [pass] | `tests.test_smoke.TestEncryption::test_plain_mode_when_no_key` | 0.178 |
| [pass] | `tests.test_smoke.TestGeminiAssistantStub::test_mode_reports_llm` | 0.229 |
| [pass] | `tests.test_smoke.TestGeminiAssistantStub::test_token_usage_accumulates` | 0.174 |
| [pass] | `tests.test_smoke.TestHasCapabilityHonorsDisabled::test_has_capability_false_when_disabled` | 0.185 |
| [pass] | `tests.test_smoke.TestHasCapabilityHonorsDisabled::test_has_capability_returns_after_enable` | 0.195 |
| [pass] | `tests.test_smoke.TestHttpSyncRoundTrip::test_http_provider_append_and_fetch` | 0.544 |
...
| [pass] | `tests.test_smoke.TestIcalExport::test_export_creates_valid_ical` | 0.211 |
| [pass] | `tests.test_smoke.TestIcalImportRoundTrip::test_import_missing_file_returns_error` | 0.142 |
| [pass] | `tests.test_smoke.TestIcalImportRoundTrip::test_roundtrip` | 0.325 |
...
| [pass] | `tests.test_smoke.TestInputValidation::test_calendar_unknown_category_normalizes` | 0.153 |
| [pass] | `tests.test_smoke.TestInputValidation::test_family_task_rejects_zero_interval` | 0.835 |
| [pass] | `tests.test_smoke.TestInputValidation::test_finance_rejects_bad_date` | 0.864 |
| [pass] | `tests.test_smoke.TestInputValidation::test_finance_rejects_negative_amount` | 0.225 |
| [pass] | `tests.test_smoke.TestInputValidation::test_social_rejects_empty_name` | 0.186 |
| [pass] | `tests.test_smoke.TestInputValidation::test_social_rejects_non_positive_cadence` | 0.195 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_action_apply_token_rejects_empty` | 0.184 |
| [pass] | `tests.test_smoke.TestLicensing::test_action_apply_token_rejects_garbage` | 0.204 |
| [pass] | `tests.test_smoke.TestLicensing::test_action_apply_token_round_trip` | 0.203 |
| [pass] | `tests.test_smoke.TestLicensing::test_action_start_trial_success_then_blocked` | 0.220 |
| [pass] | `tests.test_smoke.TestLicensing::test_activate_pro_sets_year_for_annual` | 0.232 |
| [pass] | `tests.test_smoke.TestLicensing::test_activation_rejects_free_tier` | 0.203 |
| [pass] | `tests.test_smoke.TestLicensing::test_activation_requires_withdrawal_waiver` | 0.243 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_affiliate_block_in_letter_text_is_static` | 0.229 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_cancellation_includes_affiliate_suggestions` | 0.195 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathering_migration_runs_once` | 0.212 |
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathering_skipped_for_empty_db` | 0.176 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_license_round_trip` | 0.208 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_defaults_to_free` | 0.189 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_drops_tampered_token` | 0.218 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_handles_corrupt_values` | 0.225 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_keeps_expired_token_for_grace` | 0.201 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_pricing_onboarded_flag_persists` | 0.180 |
| [pass] | `tests.test_smoke.TestLicensing::test_pro_downgrades_after_grace_period` | 0.206 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_tier_status_in_grace_period` | 0.002 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_trial_is_not_reusable` | 0.209 |
| [pass] | `tests.test_smoke.TestLicensing::test_trial_starts_and_expires` | 0.203 |
| [pass] | `tests.test_smoke.TestLicensing::test_webhook_server_end_to_end` | 0.526 |
...
| [pass] | `tests.test_smoke.TestLlmProposalValidation::test_missing_required_dropped` | 0.210 |
| [pass] | `tests.test_smoke.TestLlmProposalValidation::test_unknown_target_capability_dropped` | 0.227 |
| [pass] | `tests.test_smoke.TestModuleStatePersistence::test_disabled_module_id_persists` | 0.223 |
| [pass] | `tests.test_smoke.TestNotesModule::test_add_list_update_attach_delete` | 0.190 |
| [pass] | `tests.test_smoke.TestNotesModule::test_empty_title_rejected` | 0.166 |
| [pass] | `tests.test_smoke.TestNotesModule::test_invalid_entity_type_rejected` | 0.167 |
| [pass] | `tests.test_smoke.TestNotesModule::test_search_finds_notes` | 0.143 |
...
| [pass] | `tests.test_smoke.TestProposalUpdate::test_update_blocked_after_accept` | 0.214 |
| [pass] | `tests.test_smoke.TestProposalUpdate::test_update_payload_replaces_value` | 0.174 |
...
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_negative_recurrence_rejected` | 0.178 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_none_recurrence_ok` | 0.190 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_positive_recurrence_ok` | 0.189 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_zero_recurrence_rejected` | 0.169 |
| [pass] | `tests.test_smoke.TestRegistry::test_capabilities_registered` | 0.208 |
| [pass] | `tests.test_smoke.TestRegistry::test_module_to_module_via_context` | 0.176 |
| [pass] | `tests.test_smoke.TestRegistry::test_unknown_capability_returns_error` | 0.169 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_capability_object` | 0.178 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_none_for_disabled_module` | 0.191 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_none_for_unknown` | 0.201 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_assistant_ask_lock_serializes` | 0.168 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_bulk_complete_overdue_dispatches_individual_tasks` | 0.199 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_bulk_delete_archived_uses_repository_method` | 0.218 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_deleting_contract_cleans_attached_notes` | 0.223 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_geometry_validation` | 0.200 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_http_provider_has_read_all` | 4.284 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_export_folds_at_byte_boundary` | 0.827 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_rejects_nonexistent` | 1.007 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_rejects_path_outside_or_bad_extension` | 1.028 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_validates_recurrence` | 0.721 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_initial_lamport_ignores_other_devices` | 0.666 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_internal_capabilities_hidden_from_llm` | 0.237 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_notes_entity_id_zero_preserved` | 0.203 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_rrule_uses_yearly_for_365` | 0.191 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_sync_event_args_deep_copy` | 0.207 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_unescape_preserves_real_null_bytes` | 0.196 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_vcard_import_clamps_cadence` | 0.219 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_vcard_import_rejects_too_large` | 0.214 |
| [pass] | `tests.test_smoke.TestSearch::test_no_hit` | 0.215 |
| [pass] | `tests.test_smoke.TestSearch::test_search_finds_multiple_sources` | 0.233 |
| [pass] | `tests.test_smoke.TestSearch::test_short_query_rejected` | 0.224 |
| [pass] | `tests.test_smoke.TestSettings::test_db_value_overrides_default` | 0.180 |
| [pass] | `tests.test_smoke.TestSettings::test_defaults_when_empty` | 0.176 |
| [pass] | `tests.test_smoke.TestSettings::test_env_overrides_db` | 0.179 |
| [pass] | `tests.test_smoke.TestSettings::test_secret_is_not_persisted` | 0.185 |
...
| [pass] | `tests.test_smoke.TestStatistics::test_contracts_overview_top_3` | 0.219 |
| [pass] | `tests.test_smoke.TestStatistics::test_expenses_per_category_aggregates` | 0.193 |
| [pass] | `tests.test_smoke.TestStatistics::test_expenses_per_month_returns_buckets` | 0.223 |
| [pass] | `tests.test_smoke.TestStatistics::test_rejects_zero_months` | 0.202 |
| [pass] | `tests.test_smoke.TestStatistics::test_yearly_summary` | 0.203 |
| [pass] | `tests.test_smoke.TestSyncCompaction::test_compact_drops_oldest` | 0.027 |
| [pass] | `tests.test_smoke.TestSyncExpandedCapabilities::test_contract_replays_on_other_device` | 0.430 |
| [pass] | `tests.test_smoke.TestSyncReentry::test_non_synced_outer_lets_nested_log` | 0.235 |
| [pass] | `tests.test_smoke.TestSyncReentry::test_synced_outer_suppresses_synced_nested` | 0.225 |
...
| [pass] | `tests.test_smoke.TestThreadSafety::test_concurrent_dispatch` | 0.727 |
| [pass] | `tests.test_smoke.TestUtcTimestamps::test_event_timestamp_has_utc_marker` | 0.276 |
| [pass] | `tests.test_smoke.TestUtcTimestampsInDb::test_assistant_log_uses_utc` | 0.178 |
| [pass] | `tests.test_smoke.TestUtcTimestampsInDb::test_contract_created_at_uses_utc` | 0.176 |
| [pass] | `tests.test_smoke.TestVCardExport::test_export_creates_valid_vcard` | 0.173 |
| [pass] | `tests.test_smoke.TestVCardImportRoundTrip::test_roundtrip_preserves_rhythmus` | 0.398 |
| [pass] | `tests.test_smoke.TestYearlyPdfReport::test_pdf_report_produced` | 0.197 |
