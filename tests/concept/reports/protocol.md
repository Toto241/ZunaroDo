...
- Datum: 2026-05-20 14:53:36 UTC
- Host: Toto241 (Windows-10-10.0.26200-SP0)
- Python: 3.11.9
- Target: `tests`
- Laufzeit pytest: 161.19 s
...
| skipped | 3 |
| **gesamt** | **940** |
| Dauer (Summe) | 159.04 s |

## Abdeckung nach Konzept-Bereich (Anhang)

| Bereich (Anhang) | Tests | passed | failed | error | skipped | Dauer (s) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Kapitel 2 / Anhang D - Mitglieder-Szenarien | 18 | 18 | 0 | 0 | 0 | 70.70 |
| Anhang D - Rollen- und Berechtigungsmatrix | 69 | 69 | 0 | 0 | 0 | 1.03 |
| Kapitel 3 / Anhang C - Pairwise-Matrix | 13 | 13 | 0 | 0 | 0 | 9.49 |
| Kapitel 8 - Property-/Fuzz-Tests | 29 | 29 | 0 | 0 | 0 | 10.38 |
| Teil II Abschnitt 11 - Negativtests | 48 | 48 | 0 | 0 | 0 | 11.05 |
| Teil II Abschnitt 12 - Datenschutztests | 244 | 244 | 0 | 0 | 0 | 4.27 |
| Teil II Abschnitt 11.3 D - Security-Negativtests | 22 | 22 | 0 | 0 | 0 | 0.03 |
| Anhang J + J2 - Release-Gate | 159 | 159 | 0 | 0 | 0 | 1.26 |

## Ergebnisse pro Testdatei

| Datei | Tests | passed | failed | error | skipped | Dauer (s) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| TestAssistantLogRotation | 1 | 1 | 0 | 0 | 0 | 0.39 |
| TestAutoBackup | 2 | 2 | 0 | 0 | 0 | 0.65 |
| TestBackupAndRestore | 3 | 3 | 0 | 0 | 0 | 0.77 |
| TestBackupSqlCipherPath | 2 | 2 | 0 | 0 | 0 | 0.00 |
| TestBulkInsertPerformance | 3 | 3 | 0 | 0 | 0 | 7.73 |
...
| TestDeleteCapabilities | 4 | 4 | 0 | 0 | 0 | 0.82 |
| TestDestructiveFlags | 1 | 1 | 0 | 0 | 0 | 0.19 |
| TestDiagnose | 1 | 1 | 0 | 0 | 0 | 1.11 |
...
| TestHttpsSyncServer | 1 | 1 | 0 | 0 | 0 | 0.82 |
...
| TestRegistryGetCapability | 3 | 3 | 0 | 0 | 0 | 0.56 |
...
| TestSyncReentry | 2 | 2 | 0 | 0 | 0 | 0.43 |
...
| TestUtcTimestampsInDb | 2 | 2 | 0 | 0 | 0 | 0.36 |
| TestVCardExport | 1 | 1 | 0 | 0 | 0 | 0.18 |
| TestVCardImportRoundTrip | 1 | 1 | 0 | 0 | 0 | 0.37 |
| TestYearlyPdfReport | 1 | 1 | 0 | 0 | 0 | 0.21 |
| test_members_scenarios | 18 | 18 | 0 | 0 | 0 | 70.70 |
| test_negative_inputs | 40 | 40 | 0 | 0 | 0 | 7.88 |
| test_negative_network | 8 | 8 | 0 | 0 | 0 | 3.17 |
| test_negative_security | 22 | 22 | 0 | 0 | 0 | 0.03 |
| test_pairwise_matrix | 13 | 13 | 0 | 0 | 0 | 9.49 |
| test_privacy_data_rights | 10 | 10 | 0 | 0 | 0 | 3.85 |
| test_privacy_scan | 234 | 234 | 0 | 0 | 0 | 0.42 |
| test_properties_concept | 29 | 29 | 0 | 0 | 0 | 10.38 |
| test_protocol_generator | 4 | 4 | 0 | 0 | 0 | 0.05 |
| test_release_gate | 10 | 10 | 0 | 0 | 0 | 1.05 |
| test_release_gate_extended | 145 | 145 | 0 | 0 | 0 | 0.17 |
| test_roles_permissions | 69 | 69 | 0 | 0 | 0 | 1.03 |

## Vollstaendige Test-Liste

| Status | Test-ID | Dauer (s) |
| --- | --- | ---: |
| [pass] | `tests.concept.test_members_scenarios::test_M01_single_owner_no_rotation` | 0.384 |
| [pass] | `tests.concept.test_members_scenarios::test_M02_minimal_team_two_members` | 0.758 |
| [pass] | `tests.concept.test_members_scenarios::test_M05_meets_play_minimum_12` | 4.783 |
| [pass] | `tests.concept.test_members_scenarios::test_M06_scales_to_twenty_plus` | 6.688 |
| [pass] | `tests.concept.test_members_scenarios::test_M07_mixed_status_distribution` | 4.767 |
| [pass] | `tests.concept.test_members_scenarios::test_M08_invited_only_owner_active` | 0.594 |
| [pass] | `tests.concept.test_members_scenarios::test_M09_reactivation_restores_member` | 1.274 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-01]` | 0.397 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-02]` | 0.743 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-03]` | 1.949 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-04]` | 3.403 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-05]` | 4.643 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-06]` | 6.673 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-07]` | 4.695 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-08]` | 0.619 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-09]` | 1.218 |
| [pass] | `tests.concept.test_members_scenarios::test_get_events_handles_all_sizes` | 25.199 |
| [pass] | `tests.concept.test_members_scenarios::test_remove_and_readd_preserves_distinct_id` | 1.916 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_contract_name_does_not_break_listing` | 0.215 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[10000]` | 0.210 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[1024]` | 0.193 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[65536]` | 0.212 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description["Anna' DROP"]` | 0.199 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['  trailing space   ']` | 0.186 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description[' ']` | 0.263 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['<script>alert(1)</scrip]` | 0.192 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna \U0001f600']` | 0.184 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna\\nMehrzeilig']` | 0.179 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna\\x00Nachher']` | 0.180 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\\u202earabicRTL']` | 0.180 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\u0410\u043d\u043d\u0430 \u0418\u0432\u0430\u043d\u043e\u0432\u0430']` | 0.206 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\u5c71\u7530\u592a\u90ce']` | 0.211 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name["Anna' DROP"]` | 0.201 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['  trailing space   ']` | 0.195 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name[' ']` | 0.238 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['<script>alert(1)</scrip]` | 0.199 |
...
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['\\u202earabicRTL']` | 0.167 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['\u0410\u043d\u043d\u0430 \u0418\u0432\u0430\u043d\u043e\u0432\u0430']` | 0.209 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['\u5c71\u7530\u592a\u90ce']` | 0.213 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[%27%20OR%201=1%20--%]` | 0.178 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields['); DELETE FROM cont]` | 0.216 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[1' OR '1'='1]` | 0.207 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna"; UPDATE family]` | 0.178 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna'; DROP TABLE fa]` | 0.221 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna\\'; SELECT * FRO]` | 0.184 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[%27%20OR%201=1%20--%]` | 0.267 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal['); DELETE FROM cont]` | 0.192 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[1' OR '1'='1]` | 0.181 |
...
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna\\'; SELECT * FRO]` | 0.167 |
| [pass] | `tests.concept.test_negative_inputs::test_NA05_double_member_is_idempotent_or_distinct_ids` | 0.190 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_invalid_param_type_does_not_crash` | 0.175 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_missing_required_param_returns_friendly_error` | 0.188 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_unknown_capability_returns_friendly_error` | 0.179 |
| [pass] | `tests.concept.test_negative_network::test_NB01_unreachable_server_does_not_corrupt_state` | 2.069 |
...
| [pass] | `tests.concept.test_negative_security::test_NE02_expired_token_raises_token_expired` | 0.002 |
| [pass] | `tests.concept.test_negative_security::test_NE02_expired_token_still_provides_payload` | 0.002 |
...
| [pass] | `tests.concept.test_pairwise_matrix::test_matrix_is_deterministic` | 1.685 |
| [pass] | `tests.concept.test_pairwise_matrix::test_matrix_respects_constraints` | 0.837 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[0]` | 0.905 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[100]` | 0.792 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[125]` | 0.554 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[150]` | 0.556 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[175]` | 1.019 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[25]` | 0.820 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[50]` | 1.212 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[75]` | 1.102 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB02_purging_member_decouples_references` | 0.782 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_calendar-termine.csv-calendar]` | 0.212 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_contracts-vertraege.csv-contracts]` | 0.253 |
...
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_export_all_produces_parseable_artifacts` | 1.031 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB04_soft_delete_hides_then_restore_brings_back` | 0.249 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB06_dropping_db_file_removes_all_data` | 0.441 |
| [pass] | `tests.concept.test_privacy_data_rights::test_audit_log_format_does_not_leak_pii` | 0.204 |
...
| [pass] | `tests.concept.test_privacy_scan::test_PB01_account_deletion_capability_exists` | 0.182 |
...
| [pass] | `tests.concept.test_properties_concept::test_P1_rotation_advances_one_step` | 4.307 |
| [pass] | `tests.concept.test_properties_concept::test_P2_overdue_task_rolls_forward_to_future` | 4.349 |
...
| [pass] | `tests.concept.test_properties_concept::test_P6_pairwise_deterministic` | 1.695 |
...
| [pass] | `tests.concept.test_release_gate::test_J10_full_module_registry_assembles` | 0.210 |
...
| [pass] | `tests.concept.test_release_gate::test_J7_pairwise_matrix_has_full_coverage` | 0.834 |
...
| [pass] | `tests.concept.test_roles_permissions::test_destructive_capabilities_have_marker` | 0.250 |
| [pass] | `tests.concept.test_roles_permissions::test_guest_cannot_modify_data` | 0.000 |
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_blocks_ai_in_free` | 0.171 |
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_blocks_finance_writes_in_free` | 0.186 |
...
| [pass] | `tests.test_gui_smoke.TestGuiImports::test_geometry_helpers` | 0.073 |
...
| [pass] | `tests.test_integration.TestHttpsSyncServer::test_tls_handshake_with_self_signed_cert` | 0.819 |
...
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_insert_500_contracts_under_15s` | 3.167 |
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_insert_500_expenses_under_15s` | 3.227 |
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_list_200_contracts_under_2s` | 1.339 |
| [pass] | `tests.test_performance.TestDeadlineCalculationPerformance::test_deadline_calculation_scales` | 0.119 |
| [pass] | `tests.test_performance.TestNotesListingPerformance::test_list_attached_in_large_dataset` | 6.383 |
...
| [pass] | `tests.test_playstore_check.TestRunChecksIntegration::test_runs_without_exception` | 0.114 |
| [pass] | `tests.test_playstore_check.TestRunChecksIntegration::test_subset_only` | 0.004 |
| [pass] | `tests.test_smoke.TestAssistantLogRotation::test_log_does_not_grow_unbounded` | 0.390 |
| [pass] | `tests.test_smoke.TestAutoBackup::test_prune_old_backups_keeps_newest` | 0.271 |
| [pass] | `tests.test_smoke.TestAutoBackup::test_run_once_creates_backup_and_prunes` | 0.383 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_list_backups_sorted_newest_first` | 0.333 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_online_backup_creates_readable_copy` | 0.228 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_restore_overwrites_live_db` | 0.209 |
...
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_delete_archived` | 0.218 |
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_reject_open_proposals` | 0.230 |
| [pass] | `tests.test_smoke.TestCalendarNoMutation::test_recurring_event_not_mutated_in_db` | 0.191 |
| [pass] | `tests.test_smoke.TestCompleteTaskCatchUp::test_overdue_task_advances_rotation_multiple_times` | 0.199 |
| [pass] | `tests.test_smoke.TestConversationHistory::test_history_grows_across_calls` | 0.231 |
...
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_export_then_import_reproduces_data` | 0.415 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_invalid_dates_dont_crash` | 0.242 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_missing_csv_files_are_skipped` | 0.231 |
| [pass] | `tests.test_smoke.TestDayStructurePersistence::test_entry_persists` | 0.213 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_caps_are_destructive` | 0.194 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_contract_round_trip` | 0.216 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_member_keeps_orphan_contracts` | 0.213 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_unknown_returns_error` | 0.198 |
| [pass] | `tests.test_smoke.TestDestructiveFlags::test_critical_capabilities_are_marked` | 0.190 |
| [pass] | `tests.test_smoke.TestDiagnose::test_collect_returns_expected_shape` | 1.107 |
...
| [pass] | `tests.test_smoke.TestHasCapabilityHonorsDisabled::test_has_capability_false_when_disabled` | 0.188 |
| [pass] | `tests.test_smoke.TestHasCapabilityHonorsDisabled::test_has_capability_returns_after_enable` | 0.191 |
| [pass] | `tests.test_smoke.TestHttpSyncRoundTrip::test_http_provider_append_and_fetch` | 0.533 |
...
| [pass] | `tests.test_smoke.TestIcalImportRoundTrip::test_import_missing_file_returns_error` | 0.203 |
| [pass] | `tests.test_smoke.TestIcalImportRoundTrip::test_roundtrip` | 0.437 |
...
| [pass] | `tests.test_smoke.TestInputValidation::test_calendar_unknown_category_normalizes` | 0.219 |
| [pass] | `tests.test_smoke.TestInputValidation::test_family_task_rejects_zero_interval` | 0.217 |
| [pass] | `tests.test_smoke.TestInputValidation::test_finance_rejects_bad_date` | 0.169 |
| [pass] | `tests.test_smoke.TestInputValidation::test_finance_rejects_negative_amount` | 0.175 |
| [pass] | `tests.test_smoke.TestInputValidation::test_social_rejects_empty_name` | 0.186 |
| [pass] | `tests.test_smoke.TestInputValidation::test_social_rejects_non_positive_cadence` | 0.192 |
| [pass] | `tests.test_smoke.TestLamportCrdt::test_clock_ticks_monotonically` | 0.001 |
| [pass] | `tests.test_smoke.TestLamportCrdt::test_events_get_lamport_counter` | 0.195 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_action_apply_token_round_trip` | 0.256 |
| [pass] | `tests.test_smoke.TestLicensing::test_action_start_trial_success_then_blocked` | 0.217 |
| [pass] | `tests.test_smoke.TestLicensing::test_activate_pro_sets_year_for_annual` | 0.228 |
| [pass] | `tests.test_smoke.TestLicensing::test_activation_rejects_free_tier` | 0.186 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_affiliate_block_in_letter_text_is_static` | 0.212 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_apply_token_persists_token_string` | 0.235 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_cancellation_includes_affiliate_suggestions` | 0.194 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathered_keeps_read_but_blocks_write` | 0.292 |
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathering_migration_runs_once` | 0.259 |
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathering_skipped_for_empty_db` | 0.183 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_license_round_trip` | 0.196 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_defaults_to_free` | 0.172 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_drops_tampered_token` | 0.192 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_pricing_onboarded_flag_persists` | 0.216 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_trial_is_not_reusable` | 0.239 |
| [pass] | `tests.test_smoke.TestLicensing::test_trial_starts_and_expires` | 0.211 |
| [pass] | `tests.test_smoke.TestLicensing::test_webhook_server_end_to_end` | 0.517 |
| [pass] | `tests.test_smoke.TestLicensing::test_webhook_server_rejects_bad_signature` | 0.527 |
...
| [pass] | `tests.test_smoke.TestLlmProposalValidation::test_unknown_target_capability_dropped` | 0.207 |
| [pass] | `tests.test_smoke.TestModuleStatePersistence::test_disabled_module_id_persists` | 0.217 |
| [pass] | `tests.test_smoke.TestNotesModule::test_add_list_update_attach_delete` | 0.187 |
| [pass] | `tests.test_smoke.TestNotesModule::test_empty_title_rejected` | 0.194 |
| [pass] | `tests.test_smoke.TestNotesModule::test_invalid_entity_type_rejected` | 0.188 |
| [pass] | `tests.test_smoke.TestNotesModule::test_search_finds_notes` | 0.208 |
...
| [pass] | `tests.test_smoke.TestProposalUpdate::test_update_payload_replaces_value` | 0.241 |
| [pass] | `tests.test_smoke.TestProposalUpdate::test_update_then_accept_uses_new_payload` | 0.242 |
| [pass] | `tests.test_smoke.TestProposalsFlow::test_price_change_round_trip` | 0.209 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_invalid_date_rejected` | 0.191 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_negative_recurrence_rejected` | 0.189 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_none_recurrence_ok` | 0.232 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_positive_recurrence_ok` | 0.183 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_zero_recurrence_rejected` | 0.167 |
| [pass] | `tests.test_smoke.TestRegistry::test_capabilities_registered` | 0.196 |
| [pass] | `tests.test_smoke.TestRegistry::test_module_to_module_via_context` | 0.177 |
| [pass] | `tests.test_smoke.TestRegistry::test_unknown_capability_returns_error` | 0.174 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_capability_object` | 0.197 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_none_for_disabled_module` | 0.184 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_none_for_unknown` | 0.179 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_assistant_ask_lock_serializes` | 0.206 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_bulk_complete_overdue_dispatches_individual_tasks` | 0.229 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_bulk_delete_archived_uses_repository_method` | 0.247 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_deleting_contract_cleans_attached_notes` | 0.200 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_geometry_validation` | 0.182 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_http_provider_has_read_all` | 4.274 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_export_folds_at_byte_boundary` | 0.235 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_rejects_nonexistent` | 0.194 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_rejects_path_outside_or_bad_extension` | 0.180 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_validates_recurrence` | 0.205 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_initial_lamport_ignores_other_devices` | 0.203 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_internal_capabilities_hidden_from_llm` | 0.211 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_notes_entity_id_zero_preserved` | 0.209 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_rrule_uses_yearly_for_365` | 0.182 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_sync_event_args_deep_copy` | 0.185 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_unescape_preserves_real_null_bytes` | 0.172 |
...
| [pass] | `tests.test_smoke.TestSearch::test_search_finds_multiple_sources` | 0.193 |
| [pass] | `tests.test_smoke.TestSearch::test_short_query_rejected` | 0.191 |
| [pass] | `tests.test_smoke.TestSettings::test_db_value_overrides_default` | 0.150 |
| [pass] | `tests.test_smoke.TestSettings::test_defaults_when_empty` | 0.183 |
| [pass] | `tests.test_smoke.TestSettings::test_env_overrides_db` | 0.184 |
...
| [pass] | `tests.test_smoke.TestStatistics::test_contracts_overview_top_3` | 0.250 |
| [pass] | `tests.test_smoke.TestStatistics::test_expenses_per_category_aggregates` | 0.260 |
| [pass] | `tests.test_smoke.TestStatistics::test_expenses_per_month_returns_buckets` | 0.225 |
| [pass] | `tests.test_smoke.TestStatistics::test_rejects_zero_months` | 0.205 |
| [pass] | `tests.test_smoke.TestStatistics::test_yearly_summary` | 0.224 |
| [pass] | `tests.test_smoke.TestSyncCompaction::test_compact_drops_oldest` | 0.030 |
| [pass] | `tests.test_smoke.TestSyncExpandedCapabilities::test_contract_replays_on_other_device` | 0.400 |
| [pass] | `tests.test_smoke.TestSyncReentry::test_non_synced_outer_lets_nested_log` | 0.214 |
| [pass] | `tests.test_smoke.TestSyncReentry::test_synced_outer_suppresses_synced_nested` | 0.217 |
...
| [pass] | `tests.test_smoke.TestThreadSafety::test_concurrent_dispatch` | 0.785 |
| [pass] | `tests.test_smoke.TestUtcTimestamps::test_event_timestamp_has_utc_marker` | 0.224 |
| [pass] | `tests.test_smoke.TestUtcTimestampsInDb::test_assistant_log_uses_utc` | 0.166 |
| [pass] | `tests.test_smoke.TestUtcTimestampsInDb::test_contract_created_at_uses_utc` | 0.195 |
| [pass] | `tests.test_smoke.TestVCardExport::test_export_creates_valid_vcard` | 0.184 |
| [pass] | `tests.test_smoke.TestVCardImportRoundTrip::test_roundtrip_preserves_rhythmus` | 0.368 |
| [pass] | `tests.test_smoke.TestYearlyPdfReport::test_pdf_report_produced` | 0.209 |
