...
- Datum: 2026-05-20 17:26:08 UTC
- Host: Toto241 (Windows-10-10.0.26200-SP0)
- Python: 3.11.9
- Target: `tests`
- Laufzeit pytest: 156.92 s
...
| skipped | 3 |
| **gesamt** | **1036** |
| Dauer (Summe) | 154.85 s |

## Abdeckung nach Konzept-Bereich (Anhang)

| Bereich (Anhang) | Tests | passed | failed | error | skipped | Dauer (s) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Kapitel 2 / Anhang D - Mitglieder-Szenarien | 18 | 18 | 0 | 0 | 0 | 71.61 |
| Anhang D - Rollen- und Berechtigungsmatrix | 69 | 69 | 0 | 0 | 0 | 1.06 |
| Kapitel 3 / Anhang C - Pairwise-Matrix | 13 | 13 | 0 | 0 | 0 | 4.29 |
| Kapitel 8 - Property-/Fuzz-Tests | 29 | 29 | 0 | 0 | 0 | 10.48 |
| Teil II Abschnitt 11 - Negativtests | 48 | 48 | 0 | 0 | 0 | 11.03 |
| Teil II Abschnitt 12 - Datenschutztests | 256 | 256 | 0 | 0 | 0 | 3.02 |
| Teil II Abschnitt 11.3 D - Security-Negativtests | 22 | 22 | 0 | 0 | 0 | 0.03 |
| Play-Store-Sync (tools/playstore_sync.py) | 29 | 29 | 0 | 0 | 0 | 0.15 |
| Anhang J + J2 - Release-Gate | 214 | 214 | 0 | 0 | 0 | 2.73 |
...
| TestBackupAndRestore | 3 | 3 | 0 | 0 | 0 | 0.75 |
| TestBackupSqlCipherPath | 2 | 2 | 0 | 0 | 0 | 0.00 |
| TestBulkInsertPerformance | 3 | 3 | 0 | 0 | 0 | 7.63 |
| TestBulkOperations | 3 | 3 | 0 | 0 | 0 | 0.68 |
...
| TestConversationHistory | 1 | 1 | 0 | 0 | 0 | 0.19 |
| TestCsvExport | 2 | 2 | 0 | 0 | 0 | 0.44 |
...
| TestDeleteCapabilities | 4 | 4 | 0 | 0 | 0 | 0.77 |
| TestDestructiveFlags | 1 | 1 | 0 | 0 | 0 | 0.17 |
| TestDiagnose | 1 | 1 | 0 | 0 | 0 | 0.95 |
...
| TestIcalImportRoundTrip | 2 | 2 | 0 | 0 | 0 | 0.59 |
...
| TestVCardExport | 1 | 1 | 0 | 0 | 0 | 0.22 |
| TestVCardImportRoundTrip | 1 | 1 | 0 | 0 | 0 | 0.40 |
| TestYearlyPdfReport | 1 | 1 | 0 | 0 | 0 | 0.26 |
| test_build_status | 17 | 17 | 0 | 0 | 0 | 0.34 |
| test_dashboard_generator | 20 | 20 | 0 | 0 | 0 | 1.14 |
| test_md_to_html | 15 | 15 | 0 | 0 | 0 | 0.01 |
| test_members_scenarios | 18 | 18 | 0 | 0 | 0 | 71.61 |
| test_negative_inputs | 40 | 40 | 0 | 0 | 0 | 7.90 |
| test_negative_network | 8 | 8 | 0 | 0 | 0 | 3.13 |
| test_negative_security | 22 | 22 | 0 | 0 | 0 | 0.03 |
| test_pairwise_matrix | 13 | 13 | 0 | 0 | 0 | 4.29 |
| test_playstore_sync | 29 | 29 | 0 | 0 | 0 | 0.15 |
| test_privacy_data_rights | 10 | 10 | 0 | 0 | 0 | 2.57 |
| test_privacy_scan | 246 | 246 | 0 | 0 | 0 | 0.45 |
| test_properties_concept | 29 | 29 | 0 | 0 | 0 | 10.48 |
| test_protocol_generator | 4 | 4 | 0 | 0 | 0 | 0.05 |
| test_release_gate | 10 | 10 | 0 | 0 | 0 | 1.02 |
| test_release_gate_extended | 148 | 148 | 0 | 0 | 0 | 0.17 |
| test_roles_permissions | 69 | 69 | 0 | 0 | 0 | 1.06 |

## Vollstaendige Test-Liste

| Status | Test-ID | Dauer (s) |
| --- | --- | ---: |
| [pass] | `tests.concept.test_build_status::test_build_center_in_dashboard_html` | 0.128 |
| [pass] | `tests.concept.test_build_status::test_build_center_links_point_to_real_scripts` | 0.093 |
| [pass] | `tests.concept.test_build_status::test_build_center_section_in_index_html` | 0.014 |
...
| [pass] | `tests.concept.test_build_status::test_each_item_has_required_fields` | 0.014 |
| [pass] | `tests.concept.test_build_status::test_gather_returns_three_platforms` | 0.014 |
| [pass] | `tests.concept.test_build_status::test_index_build_center_renders_three_cards` | 0.015 |
| [pass] | `tests.concept.test_build_status::test_index_build_center_uses_clipboard_helper` | 0.014 |
| [pass] | `tests.concept.test_build_status::test_main_json_runs` | 0.014 |
| [pass] | `tests.concept.test_build_status::test_main_plain_text_runs` | 0.014 |
| [pass] | `tests.concept.test_build_status::test_pyinstaller_spec_present_for_desktop` | 0.001 |
| [pass] | `tests.concept.test_build_status::test_to_dict_is_json_serializable` | 0.013 |
...
| [pass] | `tests.concept.test_dashboard_generator::test_failure_section_shows_when_records_failed` | 0.060 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_contains_all_records` | 0.089 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_does_not_contain_nested_anchors` | 0.089 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_escapes_html_in_test_id` | 0.058 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_has_kpi_for_each_marker` | 0.088 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_has_navigation` | 0.093 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_is_self_contained` | 0.091 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_links_to_companion_artifacts` | 0.097 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_renders_decision_pill` | 0.090 |
| [pass] | `tests.concept.test_dashboard_generator::test_html_renders_skipped_as_hold` | 0.105 |
| [pass] | `tests.concept.test_dashboard_generator::test_main_handles_missing_input` | 0.003 |
| [pass] | `tests.concept.test_dashboard_generator::test_main_runs_against_real_protocol` | 0.152 |
| [pass] | `tests.concept.test_dashboard_generator::test_render_dashboard_is_deterministic` | 0.118 |
...
| [pass] | `tests.concept.test_members_scenarios::test_M01_single_owner_no_rotation` | 0.437 |
| [pass] | `tests.concept.test_members_scenarios::test_M02_minimal_team_two_members` | 0.805 |
| [pass] | `tests.concept.test_members_scenarios::test_M05_meets_play_minimum_12` | 4.747 |
| [pass] | `tests.concept.test_members_scenarios::test_M06_scales_to_twenty_plus` | 6.808 |
| [pass] | `tests.concept.test_members_scenarios::test_M07_mixed_status_distribution` | 4.921 |
| [pass] | `tests.concept.test_members_scenarios::test_M08_invited_only_owner_active` | 0.604 |
| [pass] | `tests.concept.test_members_scenarios::test_M09_reactivation_restores_member` | 1.282 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-01]` | 0.395 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-02]` | 0.844 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-03]` | 1.655 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-04]` | 3.351 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-05]` | 4.759 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-06]` | 6.916 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-07]` | 4.827 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-08]` | 0.634 |
| [pass] | `tests.concept.test_members_scenarios::test_M_can_seed_profile[M-09]` | 1.216 |
| [pass] | `tests.concept.test_members_scenarios::test_get_events_handles_all_sizes` | 25.481 |
| [pass] | `tests.concept.test_members_scenarios::test_remove_and_readd_preserves_distinct_id` | 1.926 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_contract_name_does_not_break_listing` | 0.202 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[10000]` | 0.184 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[1024]` | 0.185 |
| [pass] | `tests.concept.test_negative_inputs::test_NA02_long_member_name_is_stored_or_rejected[65536]` | 0.181 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description["Anna' DROP"]` | 0.195 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['  trailing space   ']` | 0.181 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description[' ']` | 0.200 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['<script>alert(1)</scrip]` | 0.179 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna \U0001f600']` | 0.189 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna\\nMehrzeilig']` | 0.216 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['Anna\\x00Nachher']` | 0.204 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\\u202earabicRTL']` | 0.186 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\u0410\u043d\u043d\u0430 \u0418\u0432\u0430\u043d\u043e\u0432\u0430']` | 0.199 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_expense_description['\u5c71\u7530\u592a\u90ce']` | 0.183 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name["Anna' DROP"]` | 0.197 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['  trailing space   ']` | 0.273 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name[' ']` | 0.202 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['<script>alert(1)</scrip]` | 0.191 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['Anna \U0001f600']` | 0.209 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['Anna\\nMehrzeilig']` | 0.228 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['Anna\\x00Nachher']` | 0.215 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['\\u202earabicRTL']` | 0.197 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['\u0410\u043d\u043d\u0430 \u0418\u0432\u0430\u043d\u043e\u0432\u0430']` | 0.190 |
| [pass] | `tests.concept.test_negative_inputs::test_NA03_special_chars_in_member_name['\u5c71\u7530\u592a\u90ce']` | 0.182 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[%27%20OR%201=1%20--%]` | 0.213 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields['); DELETE FROM cont]` | 0.183 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[1' OR '1'='1]` | 0.200 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna"; UPDATE family]` | 0.188 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna'; DROP TABLE fa]` | 0.184 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_contract_fields[Anna\\'; SELECT * FRO]` | 0.225 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[%27%20OR%201=1%20--%]` | 0.187 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal['); DELETE FROM cont]` | 0.216 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[1' OR '1'='1]` | 0.209 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna"; UPDATE family]` | 0.179 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna'; DROP TABLE fa]` | 0.213 |
| [pass] | `tests.concept.test_negative_inputs::test_NA04_sql_injection_in_member_name_is_literal[Anna\\'; SELECT * FRO]` | 0.187 |
| [pass] | `tests.concept.test_negative_inputs::test_NA05_double_member_is_idempotent_or_distinct_ids` | 0.220 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_invalid_param_type_does_not_crash` | 0.187 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_missing_required_param_returns_friendly_error` | 0.162 |
| [pass] | `tests.concept.test_negative_inputs::test_NA11_unknown_capability_returns_friendly_error` | 0.175 |
...
| [pass] | `tests.concept.test_pairwise_matrix::test_matrix_is_deterministic` | 1.580 |
| [pass] | `tests.concept.test_pairwise_matrix::test_matrix_respects_constraints` | 0.811 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[0]` | 0.198 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[100]` | 0.221 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[125]` | 0.185 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[150]` | 0.243 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[175]` | 0.282 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[25]` | 0.210 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[50]` | 0.282 |
| [pass] | `tests.concept.test_pairwise_matrix::test_sampled_cases_persist_in_real_repo[75]` | 0.269 |
| [pass] | `tests.concept.test_playstore_sync::test_cli_export_writes_snapshot` | 0.023 |
...
| [pass] | `tests.concept.test_playstore_sync::test_cli_validate_on_sample` | 0.020 |
...
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_calendar-termine.csv-calendar]` | 0.251 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_contracts-vertraege.csv-contracts]` | 0.244 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_expenses-ausgaben.csv-expenses]` | 0.327 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_family-haushalt.csv-family]` | 0.177 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_each_exporter_produces_header[export_social-kontakte.csv-social]` | 0.228 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB03_export_all_produces_parseable_artifacts` | 0.220 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB04_soft_delete_hides_then_restore_brings_back` | 0.227 |
| [pass] | `tests.concept.test_privacy_data_rights::test_PB06_dropping_db_file_removes_all_data` | 0.427 |
| [pass] | `tests.concept.test_privacy_data_rights::test_audit_log_format_does_not_leak_pii` | 0.246 |
...
| [pass] | `tests.concept.test_properties_concept::test_P1_rotation_advances_one_step` | 4.412 |
| [pass] | `tests.concept.test_properties_concept::test_P2_overdue_task_rolls_forward_to_future` | 4.446 |
...
| [pass] | `tests.concept.test_properties_concept::test_P6_pairwise_deterministic` | 1.598 |
...
| [pass] | `tests.concept.test_protocol_generator::test_protocol_formats_markdown` | 0.039 |
| [pass] | `tests.concept.test_protocol_generator::test_protocol_parses_junit` | 0.003 |
| [pass] | `tests.concept.test_release_gate::test_J10_full_module_registry_assembles` | 0.192 |
...
| [pass] | `tests.concept.test_release_gate::test_J7_pairwise_matrix_has_full_coverage` | 0.825 |
...
| [pass] | `tests.concept.test_roles_permissions::test_destructive_capabilities_have_marker` | 0.197 |
...
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_blocks_finance_writes_in_free` | 0.212 |
| [pass] | `tests.concept.test_roles_permissions::test_license_gate_passes_family_in_free` | 0.207 |
...
| [pass] | `tests.concept.test_roles_permissions::test_owner_concept_role_maps_to_pro_license` | 0.192 |
| [pass] | `tests.test_gui_smoke.TestGuiImports::test_geometry_helpers` | 0.091 |
...
| [pass] | `tests.test_integration.TestHttpsSyncServer::test_tls_handshake_with_self_signed_cert` | 0.774 |
| [pass] | `tests.test_integration.TestImapAbruf::test_fetch_imap_loops_through_unseen` | 0.149 |
...
| [pass] | `tests.test_integration.TestPrinten::test_print_file_calls_subprocess_on_unix` | 0.023 |
...
| [pass] | `tests.test_integration.TestSmtpVersand::test_send_smtp_without_config_returns_skip` | 0.005 |
...
| [pass] | `tests.test_mobile_helpers.TestFormatCurrency::test_normal` | 0.003 |
...
| [pass] | `tests.test_pairing.TestKeyringSecureStore::test_delete_removes_from_list` | 0.029 |
...
| [pass] | `tests.test_pairing_handshake.TestPairingFailures::test_responder_with_wrong_initiator_pubkey_in_invitation` | 0.020 |
| [pass] | `tests.test_pairing_handshake.TestPairingFailures::test_wrong_ot_secret_breaks_handshake` | 0.020 |
...
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_insert_500_contracts_under_15s` | 3.159 |
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_insert_500_expenses_under_15s` | 3.066 |
| [pass] | `tests.test_performance.TestBulkInsertPerformance::test_list_200_contracts_under_2s` | 1.404 |
| [pass] | `tests.test_performance.TestDeadlineCalculationPerformance::test_deadline_calculation_scales` | 0.118 |
| [pass] | `tests.test_performance.TestNotesListingPerformance::test_list_attached_in_large_dataset` | 6.269 |
...
| [pass] | `tests.test_playstore_check.TestRunChecksIntegration::test_runs_without_exception` | 0.120 |
| [pass] | `tests.test_playstore_check.TestRunChecksIntegration::test_subset_only` | 0.004 |
| [pass] | `tests.test_smoke.TestAssistantLogRotation::test_log_does_not_grow_unbounded` | 0.403 |
| [pass] | `tests.test_smoke.TestAutoBackup::test_prune_old_backups_keeps_newest` | 0.258 |
| [pass] | `tests.test_smoke.TestAutoBackup::test_run_once_creates_backup_and_prunes` | 0.317 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_list_backups_sorted_newest_first` | 0.297 |
| [pass] | `tests.test_smoke.TestBackupAndRestore::test_online_backup_creates_readable_copy` | 0.235 |
...
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_complete_overdue_tasks` | 0.257 |
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_delete_archived` | 0.211 |
| [pass] | `tests.test_smoke.TestBulkOperations::test_bulk_reject_open_proposals` | 0.213 |
| [pass] | `tests.test_smoke.TestCalendarNoMutation::test_recurring_event_not_mutated_in_db` | 0.156 |
| [pass] | `tests.test_smoke.TestCompleteTaskCatchUp::test_overdue_task_advances_rotation_multiple_times` | 0.245 |
| [pass] | `tests.test_smoke.TestConversationHistory::test_history_grows_across_calls` | 0.194 |
| [pass] | `tests.test_smoke.TestCsvExport::test_export_all_writes_five_files` | 0.221 |
| [pass] | `tests.test_smoke.TestCsvExport::test_export_contracts_writes_csv` | 0.218 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_export_then_import_reproduces_data` | 0.479 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_invalid_dates_dont_crash` | 0.225 |
| [pass] | `tests.test_smoke.TestCsvImportRoundTrip::test_missing_csv_files_are_skipped` | 0.233 |
| [pass] | `tests.test_smoke.TestDayStructurePersistence::test_entry_persists` | 0.188 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_caps_are_destructive` | 0.192 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_contract_round_trip` | 0.191 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_member_keeps_orphan_contracts` | 0.199 |
| [pass] | `tests.test_smoke.TestDeleteCapabilities::test_delete_unknown_returns_error` | 0.189 |
| [pass] | `tests.test_smoke.TestDestructiveFlags::test_critical_capabilities_are_marked` | 0.170 |
| [pass] | `tests.test_smoke.TestDiagnose::test_collect_returns_expected_shape` | 0.951 |
| [pass] | `tests.test_smoke.TestDisabledModuleSurfaced::test_disabled_contracts_yields_warning_in_finance_events` | 0.188 |
| [pass] | `tests.test_smoke.TestEncryption::test_encryption_requires_sqlcipher3` | 0.003 |
| [pass] | `tests.test_smoke.TestEncryption::test_plain_mode_when_no_key` | 0.191 |
| [pass] | `tests.test_smoke.TestGeminiAssistantStub::test_mode_reports_llm` | 0.222 |
| [pass] | `tests.test_smoke.TestGeminiAssistantStub::test_token_usage_accumulates` | 0.170 |
| [pass] | `tests.test_smoke.TestHasCapabilityHonorsDisabled::test_has_capability_false_when_disabled` | 0.210 |
| [pass] | `tests.test_smoke.TestHasCapabilityHonorsDisabled::test_has_capability_returns_after_enable` | 0.210 |
| [pass] | `tests.test_smoke.TestHttpSyncRoundTrip::test_http_provider_append_and_fetch` | 0.526 |
...
| [pass] | `tests.test_smoke.TestIcalExport::test_export_creates_valid_ical` | 0.188 |
| [pass] | `tests.test_smoke.TestIcalImportRoundTrip::test_import_missing_file_returns_error` | 0.192 |
| [pass] | `tests.test_smoke.TestIcalImportRoundTrip::test_roundtrip` | 0.399 |
...
| [pass] | `tests.test_smoke.TestInputValidation::test_finance_rejects_bad_date` | 0.195 |
| [pass] | `tests.test_smoke.TestInputValidation::test_finance_rejects_negative_amount` | 0.214 |
| [pass] | `tests.test_smoke.TestInputValidation::test_social_rejects_empty_name` | 0.203 |
| [pass] | `tests.test_smoke.TestInputValidation::test_social_rejects_non_positive_cadence` | 0.212 |
| [pass] | `tests.test_smoke.TestLamportCrdt::test_clock_ticks_monotonically` | 0.001 |
| [pass] | `tests.test_smoke.TestLamportCrdt::test_events_get_lamport_counter` | 0.208 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_action_apply_token_rejects_garbage` | 0.191 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_activate_pro_sets_year_for_annual` | 0.212 |
| [pass] | `tests.test_smoke.TestLicensing::test_activation_rejects_free_tier` | 0.210 |
| [pass] | `tests.test_smoke.TestLicensing::test_activation_requires_withdrawal_waiver` | 0.239 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_affiliate_block_in_letter_text_is_static` | 0.193 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_apply_token_persists_token_string` | 0.214 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_cancellation_includes_affiliate_suggestions` | 0.199 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathered_keeps_read_but_blocks_write` | 0.224 |
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathering_migration_runs_once` | 0.227 |
| [pass] | `tests.test_smoke.TestLicensing::test_grandfathering_skipped_for_empty_db` | 0.208 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_license_round_trip` | 0.224 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_defaults_to_free` | 0.200 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_drops_tampered_token` | 0.207 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_handles_corrupt_values` | 0.174 |
| [pass] | `tests.test_smoke.TestLicensing::test_load_license_keeps_expired_token_for_grace` | 0.188 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_pricing_onboarded_flag_persists` | 0.192 |
| [pass] | `tests.test_smoke.TestLicensing::test_pro_downgrades_after_grace_period` | 0.221 |
...
| [pass] | `tests.test_smoke.TestLicensing::test_trial_is_not_reusable` | 0.214 |
| [pass] | `tests.test_smoke.TestLicensing::test_trial_starts_and_expires` | 0.232 |
| [pass] | `tests.test_smoke.TestLicensing::test_webhook_server_end_to_end` | 0.514 |
| [pass] | `tests.test_smoke.TestLicensing::test_webhook_server_rejects_bad_signature` | 0.516 |
...
| [pass] | `tests.test_smoke.TestLlmProposalValidation::test_missing_required_dropped` | 0.185 |
| [pass] | `tests.test_smoke.TestLlmProposalValidation::test_unknown_target_capability_dropped` | 0.184 |
| [pass] | `tests.test_smoke.TestModuleStatePersistence::test_disabled_module_id_persists` | 0.198 |
| [pass] | `tests.test_smoke.TestNotesModule::test_add_list_update_attach_delete` | 0.261 |
| [pass] | `tests.test_smoke.TestNotesModule::test_empty_title_rejected` | 0.195 |
| [pass] | `tests.test_smoke.TestNotesModule::test_invalid_entity_type_rejected` | 0.181 |
...
| [pass] | `tests.test_smoke.TestProfile::test_two_profiles_use_separate_files` | 0.347 |
...
| [pass] | `tests.test_smoke.TestProposalUpdate::test_update_then_accept_uses_new_payload` | 0.196 |
| [pass] | `tests.test_smoke.TestProposalsFlow::test_price_change_round_trip` | 0.203 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_invalid_date_rejected` | 0.186 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_negative_recurrence_rejected` | 0.182 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_none_recurrence_ok` | 0.193 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_positive_recurrence_ok` | 0.206 |
| [pass] | `tests.test_smoke.TestRecurrenceValidation::test_zero_recurrence_rejected` | 0.201 |
| [pass] | `tests.test_smoke.TestRegistry::test_capabilities_registered` | 0.254 |
| [pass] | `tests.test_smoke.TestRegistry::test_module_to_module_via_context` | 0.201 |
| [pass] | `tests.test_smoke.TestRegistry::test_unknown_capability_returns_error` | 0.205 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_capability_object` | 0.195 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_none_for_disabled_module` | 0.203 |
| [pass] | `tests.test_smoke.TestRegistryGetCapability::test_returns_none_for_unknown` | 0.190 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_assistant_ask_lock_serializes` | 0.185 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_bulk_complete_overdue_dispatches_individual_tasks` | 0.218 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_bulk_delete_archived_uses_repository_method` | 0.234 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_deleting_contract_cleans_attached_notes` | 0.209 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_geometry_validation` | 0.201 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_http_provider_has_read_all` | 4.307 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_export_folds_at_byte_boundary` | 0.268 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_rejects_nonexistent` | 0.166 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_rejects_path_outside_or_bad_extension` | 0.183 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_ical_import_validates_recurrence` | 0.180 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_initial_lamport_ignores_other_devices` | 0.191 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_internal_capabilities_hidden_from_llm` | 0.174 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_notes_entity_id_zero_preserved` | 0.202 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_rrule_uses_yearly_for_365` | 0.200 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_sync_event_args_deep_copy` | 0.207 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_unescape_preserves_real_null_bytes` | 0.203 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_vcard_import_clamps_cadence` | 0.212 |
| [pass] | `tests.test_smoke.TestReviewFixes::test_vcard_import_rejects_too_large` | 0.181 |
| [pass] | `tests.test_smoke.TestSearch::test_no_hit` | 0.213 |
| [pass] | `tests.test_smoke.TestSearch::test_search_finds_multiple_sources` | 0.174 |
| [pass] | `tests.test_smoke.TestSearch::test_short_query_rejected` | 0.166 |
| [pass] | `tests.test_smoke.TestSettings::test_db_value_overrides_default` | 0.204 |
| [pass] | `tests.test_smoke.TestSettings::test_defaults_when_empty` | 0.197 |
| [pass] | `tests.test_smoke.TestSettings::test_env_overrides_db` | 0.213 |
...
| [pass] | `tests.test_smoke.TestStatistics::test_contracts_overview_top_3` | 0.221 |
| [pass] | `tests.test_smoke.TestStatistics::test_expenses_per_category_aggregates` | 0.223 |
| [pass] | `tests.test_smoke.TestStatistics::test_expenses_per_month_returns_buckets` | 0.224 |
| [pass] | `tests.test_smoke.TestStatistics::test_rejects_zero_months` | 0.245 |
| [pass] | `tests.test_smoke.TestStatistics::test_yearly_summary` | 0.261 |
| [pass] | `tests.test_smoke.TestSyncCompaction::test_compact_drops_oldest` | 0.031 |
| [pass] | `tests.test_smoke.TestSyncExpandedCapabilities::test_contract_replays_on_other_device` | 0.342 |
| [pass] | `tests.test_smoke.TestSyncReentry::test_non_synced_outer_lets_nested_log` | 0.189 |
| [pass] | `tests.test_smoke.TestSyncReentry::test_synced_outer_suppresses_synced_nested` | 0.199 |
...
| [pass] | `tests.test_smoke.TestThreadSafety::test_concurrent_dispatch` | 0.877 |
| [pass] | `tests.test_smoke.TestUtcTimestamps::test_event_timestamp_has_utc_marker` | 0.195 |
| [pass] | `tests.test_smoke.TestUtcTimestampsInDb::test_assistant_log_uses_utc` | 0.217 |
| [pass] | `tests.test_smoke.TestUtcTimestampsInDb::test_contract_created_at_uses_utc` | 0.185 |
| [pass] | `tests.test_smoke.TestVCardExport::test_export_creates_valid_vcard` | 0.219 |
| [pass] | `tests.test_smoke.TestVCardImportRoundTrip::test_roundtrip_preserves_rhythmus` | 0.402 |
| [pass] | `tests.test_smoke.TestYearlyPdfReport::test_pdf_report_produced` | 0.262 |
